...
ARG FEATURE_FLAGS
ARG NEXT_PUBLIC_BRANDING_DOMAIN
ARG NEXT_PUBLIC_BRANDING_NAME
...
ENV NEXT_PUBLIC_SERVICE_MODE="${NEXT_PUBLIC_SERVICE_MODE:-server}" \
    ...
    NEXT_PUBLIC_BRANDING_DOMAIN="${NEXT_PUBLIC_BRANDING_DOMAIN:-lobehub.com}" \
    NEXT_PUBLIC_BRANDING_NAME="${NEXT_PUBLIC_BRANDING_NAME:-LobeChat}"
