      ...
      <div style={{width: '80%', margin: '0 auto'}}>
        ...
        <div style={{fontSize: '16px', textAlign: 'justify'}}>
          ...
          <p>
            ...
            understood, and agreed to be bound by all the terms of this Agreement. If You do not agree
            to any part of this Agreement, You are not permitted to continue accessing or using the
            Services.
          </p>
          <h2>Definitions</h2>
          <p>
          ...
          <p>
            ...
            open-source communities. The Service facilitates functions such as information retrieval,
            content creation, and automation through user interaction with AI systems. Additionally,
            it utilizes cloud technology to provide capabilities like data synchronization, vector
            data storage, server-side functionalities, etc., to enhance the interactive experience
            with AI models.
          </p>
          <h2>Eligibility</h2>
          <p>
            ...
            these terms. (3)Will use the Services in accordance with this Agreement and all applicable
            laws. (4)Will not use the Services for any illegal, harmful, dangerous, or offensive
            purposes.
          </p>
          ...
          <p>
            ...
            legality, reliability, and appropriateness of the content generated using the AI ability.
            We do not assume responsibility for user-generated content on the Services. You explicitly
            understand and agree that You are solely responsible for the content You post and all
            activities conducted under Your account, whether by Yourself or by third parties using
            Your account.
          </p>
          <p>
            By generating and publishing content in the Services, You grant us the rights and licenses
            necessary to use, modify, publicly perform, publicly display, copy, and distribute such
            content within the Services. You retain full ownership of all content created, published,
            or displayed within the Services and are responsible for maintaining these rights. You
            agree that this license includes the permission for us to provide Your content to other
            Service users for their use under these terms. Additionally, You declare and warrant that:
            (1) the content is owned by You or You have the legal right to use and authorize it to us
            under this agreement. (2) posting the shared information in the Services will not infringe
            upon the privacy rights, image rights, copyrights, contractual relationships, or other
          ...
          <p>
            We do not assume any responsibility for the security and integrity of content in the event
            of content damage or loss under any circumstances.
          </p>
          ...
          <p>
            ...
            translate, create derivative works, reverse engineer, disassemble, or decompile the
          ...
          <p>
            ...
            beginning and provide notice within the Services to inform You of significant changes. It
            is Your responsibility to regularly review these legal terms to stay informed of any
          ...
          <p>
            ...
            parties agree that any dispute arising out of or in connection with this Agreement or the
            Services shall be submitted to choose one court with competent jurisdiction for resolution
            through litigation. You may also be required to comply with the laws of your local
            jurisdiction, province, country, or international laws when using the Services.
          </p>
          <h2>Conclusion</h2>
          <p>
