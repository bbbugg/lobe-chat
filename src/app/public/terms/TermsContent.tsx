    ...
    >
      ...
      <div style={{ margin: '0 auto', width: '80%' }}>
        ...
        <div style={{ fontSize: '16px', textAlign: 'justify' }}>
          ...
          <p>
            Welcome to {BRANDING_NAME}! Please carefully read the following Terms of Use
            (hereinafter referred to as the &quot;Agreement&quot;). This Agreement constitutes a
            legally binding agreement between You and {BRANDING_NAME} regarding the access and use
            of the {BRANDING_NAME} website (collectively referred to as the &quot;Services&quot;).
          </p>
          <p>
          ...
          <p>
            ...
            restricting access. You must immediately notify {BRANDING_NAME} of any unauthorized
          ...
          <p>
            {BRANDING_NAME} reserves all rights to the technology, software, first-party content,
            and data within the Services, including but not limited to patents, trademarks, trade
          ...
          <p>
            {BRANDING_NAME} employs industry-standard technical, managerial, and physical security
            ...
            breaches will never occur. {BRANDING_NAME} is not liable for any damages or liabilities
          ...
          <p>
            ...
            violation of the terms of the agreement, {BRANDING_NAME} may immediately suspend or
            terminate Your access to the Services. Upon termination, You will immediately lose the
            right to access or use the Services. {BRANDING_NAME} will not be liable to You or any
          ...
          <p>
            In no event shall {BRANDING_NAME}, its Affiliates, directors, employees, or agents be
            liable for any direct, indirect, punitive, incidental, special, or consequential damages
          ...
          <h2>Conclusion</h2>
          <p>
            This agreement represents the entire agreement between You and {BRANDING_NAME} regarding
            the use of the Services. It supersedes any prior agreements or understandings. The
            failure of {BRANDING_NAME} to enforce any provision of this agreement does not
